...
from models.model_rnabert import FullModel
...
# Define output name
outputname = "rnabert_experiment"  # Change this to your desired output name
...
for fold, (train_idx, val_idx) in enumerate(kf.split(train_loader.dataset)):
    ...
    model = FullModel(rna_bert, input_size).to(device)
